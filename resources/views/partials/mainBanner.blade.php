<div class="containerBanner">
    <div class="info-card">
    <img src="{{ asset('images/buy-comics-digital-comics.png') }}" alt="DC" /> <a href="">DIGITAL COMICS</a>
    </div>

    <div class="info-card">
    <img src="{{ asset('images/buy-comics-merchandise.png') }}" alt="DC" />  <a href="">DC MERCHANDISE</a>
    </div>

    <div class="info-card">
    <img src="{{ asset('images/buy-comics-subscriptions.png') }}" alt="DC" /> <a href="">SUBSCRIPTION</a>
    </div>

    <div class="info-card">
    <img src="{{ asset('images/buy-comics-shop-locator.png') }}" alt="DC" /> <a href="">COMIC SHOP LOCATOR</a>
    </div>
